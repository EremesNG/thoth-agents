...
| Codex | Ambient Codex session with managed root instructions | Nine custom-agent TOMLs | `~/.codex/skills` |
| Claude Code | Plugin `orchestrator` activated by `settings.json` | Nine plugin subagents | `~/.claude/skills` |
