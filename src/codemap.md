...
## Responsibility
- `src/index.ts` delivers the thoth-agents plugin by merging configuration, instantiating orchestrator/subagent definitions, wiring tmux helpers, built-in tools, MCPs, and lifecycle hooks so OpenCode sees a single cohesive module.
