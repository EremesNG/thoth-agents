...
Durable behavioral contract for `memory-orchestration`.

## Requirements

### Requirement: Root memory routing

The adaptive root MUST route recall, durable lessons, verified compaction, and meaningful semantic completion through the installed thoth-mem skill while retaining root-only lifecycle and real-user-intent ownership.
