---
name: quick
description: Implement narrow or mechanical changes with focused verification.
model: haiku
---
...
- Mode: write-capable
- Scope: fast bounded implementation
- Responsibility: Implement narrow or mechanical changes with focused verification.
