...
| direct/accelerated/full routing, phase protocols/envelopes, architectural grilling, Spec Kit artifacts, verify/converge/archive | [`sdd-and-skills.md`](sdd-and-skills.md) | `src/harness/core/sdd.ts`, phase-agent prompts | `src/harness/core/sdd.test.ts`, `sdd-protocol.test.ts`, prompt tests | memory boundary |
